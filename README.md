...
```
	{
		...
		{"class":"BaiduAdapter","priority":10,"key1":"appid","key2":"bannerid","param":"Interstitial ID"},//baidu ssp platform,param can been Interstitial id or json string {"interstitialID":"interstitial ID","videoID":" video ID"}
		...
		{"class":"InmobiAdapter","priority":10,"key1":"property id","key2":"banner id","key3":"interstitial id"},//inmobi ,key1 appid 
